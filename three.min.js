...
(function() {
    ...
    function CanvasTexture(canvas) {
        ...
        if (!(this instanceof CanvasTexture)) {
    ...
    try {
        ...
        THREE.CanvasTexture = function(canvas) {
            if (!(this instanceof THREE.CanvasTexture)) {
    ...
    console.log('THREE.js compatible library loaded with 2D fallback renderer - v2025-07-29-05');
})();