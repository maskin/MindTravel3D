...
(function(global) {
    ...
    THREE.WebGLRenderer.prototype = {
        ...
        draw3DPerspectiveMaze: function(ctx, canvas, maze, mazeWidth, mazeHeight, playerX, playerZ, playerAngle) {
            ...
            gradient.addColorStop(0, '#4A90E2'); // 空色
            gradient.addColorStop(0.5, '#7BB3F0');
            gradient.addColorStop(1, '#2D5AA0'); // 地平線
            ...
            ctx.fillText('3D迷路ビュー', 20, 40);
            
            ctx.font = '12px Arial';
            ctx.fillStyle = 'rgba(255, 255, 255, 0.8)';
            ctx.fillText('位置: (' + playerX.toFixed(1) + ', ' + playerZ.toFixed(1) + ')', 20, 60);
            ctx.fillText('方向: ' + (playerAngle * 180 / Math.PI).toFixed(0) + '°', 20, 80);
